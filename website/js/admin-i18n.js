...
(function (global) {
    ...
    var DICT = {
        en: {
            ...
            'marketing.effects_rebate_title': 'Rebate performance',
            'marketing.effects_promo_title': 'Promotion performance',
            'marketing.effects_ref_title': 'Referral performance',
            'marketing.effects_demo': 'Demo metrics — connect BI / orders API later.',
            'marketing.fx_period': 'Period',
            'marketing.fx_orders': 'Qualified orders',
            'marketing.fx_issued': 'Rebate issued ($)',
            'marketing.fx_pending': 'Pending ($)',
            'marketing.fx_promo_name': 'Rule / label',
            'marketing.fx_uses': 'Uses',
            'marketing.fx_attr_rev': 'Attributed revenue ($)',
            'marketing.fx_conv': 'Conv. %',
            'marketing.fx_clicks': 'Link clicks',
            'marketing.fx_signups': 'Signups',
            'marketing.fx_first_orders': 'First orders',
            'marketing.fx_rewards_paid': 'Rewards paid ($)',
            'table.phone': 'Phone',
        ...
        zh: {
            ...
            'marketing.effects_rebate_title': '返利效果',
            'marketing.effects_promo_title': '促销效果',
            'marketing.effects_ref_title': '推广效果',
            'marketing.effects_demo': '演示指标，后续可对接报表 / 订单 API。',
            'marketing.fx_period': '周期',
            'marketing.fx_orders': '达标订单数',
            'marketing.fx_issued': '已发放返利 ($)',
            'marketing.fx_pending': '待结算 ($)',
            'marketing.fx_promo_name': '规则 / 名称',
            'marketing.fx_uses': '使用次数',
            'marketing.fx_attr_rev': '带动销售额 ($)',
            'marketing.fx_conv': '转化率 %',
            'marketing.fx_clicks': '链接点击',
            'marketing.fx_signups': '注册数',
            'marketing.fx_first_orders': '首单数',
            'marketing.fx_rewards_paid': '已发奖励 ($)',
            'table.phone': '电话',
